  ...
  return (
    ...
    <Layout>
        ...
        <div className='w-full lg:px-28 px-5 pb-10 bg-light grid grid-cols-1 gap-10'>
          ...
          <div className='w-full flex lg:flex-row flex-col justify-center items-start lg;gap-24 gap-5'>
            <div className='lg:w-[50%] w-full'>
              <img src='/assets/about-us/mission.png'/>
            </div>
            <div className='lg:w-[50%] w-full bg-white p-4 rounded-lg card-shadow'>
              <h1 className={`text-2xl font-bold text-primaryGreen ${lexend.className}`}>Our Mission</h1>
              <p className={`lg:text-base text-sm mt-3 ${poppins.className}`}>To deliver superior quality health care with a human touch, in a caring, compassionate and hygienic environment. To serve and enhance the quality of health of ailing patients through the effective deployment of medical expertise and technology, combined with a focus on affordability, accessibility and availability.</p>
            </div>
          </div>
          ...
          <div className='w-full flex lg:flex-row flex-col-reverse justify-center items-start lg;gap-24 gap-5'>
            <div className='lg:w-[50%] w-full bg-white p-4 rounded-lg card-shadow'>
              ...
              <p className={`lg:text-base text-sm mt-3 ${poppins.className}`}>Quality without compromise; Competence with compassion; Care with concern; Cost effective medical treatment with consistency and continuous improvement in skills, services and technology.</p>
            </div>
            <div className='lg:w-[50%] w-full'>
